...
| ![](hhttps://raw.githubusercontent.com/DestroyedClone/RiskyClassicItems/master/Art%20Assets/items/texIconClassicPills.png) | Prescriptions | Enter a `drug-induced frenzy` for `8` seconds, increasing `damage` by `20%` and `attack speed` by `40%`.
...
| ![](https://raw.githubusercontent.com/DestroyedClone/RiskyClassicItems/master/Art%20Assets/items/texIconClassicSquib.png) | Thqwibs | Release a bloom of `15` Thqwibs, detonating on impact for `360% damage` each.
